...
CarUpdate_t::CarUpdate_t(/*DateTime LastUpdate,*/ boost::shared_ptr<CarStatus_t> _pStatus, Point_t & _GoalPosition,
	...
	: Model_t(CAR_UPDATE), pStatus(_pStatus), GoalPosition(_GoalPosition), pEmergency(_pEmergency),
	  BlueLight(_BlueLight), isServerStatus(_isServerStatus)
{
}
...
string CarUpdate_t::ToString() const
{
	stringstream ss;
